        ...
        <main>
            ...
            <div class="store-content">
                ...
                <div class="featured-product">
                    <h3 class="section-tittle">Featured Products</h3>
                    <div class="item1">
                        <h5 class="item-name">ALLURE HOMME</h5>
                    
                        <div class="item-photo">
                            <a href="../products/ALLURE HOMME.html"><img src="https://www.chanel.com/images//t_one//w_0.51,h_0.51,c_crop/q_auto:good,f_jpg,fl_lossy,dpr_1.2/w_1240/allure-homme-edition-blanche-shower-gel-6-8fl-oz--packshot-default-127960-8824200658974.jpg" alt="ALLURE HOMME">
                        </div></a>
                        <div class="item-price">
                            <div class="item1">$350</div>
                        </div>
                        <p><button type="button" class="shopping-cart">Add to cart</button></p> 
                        <p><button type="button" class="shopping-cart">Buy Now</button></p>
                    </div>
                </div>
                <div class="featured-product">
                    <h3 class="section-tittle">New Products</h3>
                    <div class="item3">
                        <h5 class="item-name">BLEU DE CHANEL</h5>                
                    <div class="item-photo">
                        <a href="../products/BLEU DE CHANEL.html"><img src="https://www.chanel.com/images//t_one//w_0.51,h_0.51,c_crop/q_auto:good,f_jpg,fl_lossy,dpr_1.2/w_1240/bleu-de-chanel-shower-gel-6-8fl-oz--packshot-default-107960-8823574036510.jpg" alt="BLEU DE CHANEL"></a>
                    </div>
                    <div class="item-price">
                    <div class="item1">$1,800</div>               
                    </div>
                    <p><button type="button" class="shopping-cart">Add to cart</button></p> 
                    <p><button type="button" class="shopping-cart">Buy Now</button></p>
                </div>
            ...
            <div class="store-footer">
                <div class="store-copyright">
                    <a href="../../sub/store-copyrights.html"><span>&copy;</span>Copyrights</a>
                </div>
                <div class="store-tos">
                    <a href="../../sub/store-tos.html">Terms of Service</a>
                </div>
                <div class="store-privacy">
                    <a href="../../sub/store-privacy.html">Privacy Policies</a>
                </div>
            </div>
        </main>
